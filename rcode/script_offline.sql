...
select
	...
	sum(case when type = 1 then 1 else 0 end) as type1_cnt, -- type1记录数，浏览
	sum(case when type = 2 then 1 else 0 end) as type2_cnt, -- type2记录数，加入购物车
	sum(case when type = 3 then 1 else 0 end) as type3_cnt, -- type3记录数，购物车删除
	sum(case when type = 4 then 1 else 0 end) as type4_cnt, -- type4记录数，下单
	sum(case when type = 5 then 1 else 0 end) as type5_cnt, -- type5记录数，关注
	sum(case when type = 6 then 1 else 0 end) as type6_cnt, -- type6记录数，点击
	
	sum(case when cate = 4 then 1 else 0 end) as cate4_cnt, -- cate4记录数
	sum(case when cate = 5 then 1 else 0 end) as cate5_cnt, -- cate5记录数
	sum(case when cate = 6 then 1 else 0 end) as cate6_cnt, -- cate6记录数
	sum(case when cate = 7 then 1 else 0 end) as cate7_cnt, -- cate7记录数
	sum(case when cate = 8 then 1 else 0 end) as cate8_cnt, -- cate8记录数
	sum(case when cate = 9 then 1 else 0 end) as cate9_cnt, -- cate9记录数
	sum(case when cate = 10 then 1 else 0 end) as cate10_cnt, -- cate10记录数
	sum(case when cate = 11 then 1 else 0 end) as cate11_cnt, -- cate11记录数
	...
	count(distinct case when cate = 6 and type = 1 then sku_id else null end) as cate6_type1_sku_cnt, -- cate6，type1商品数
	count(distinct case when cate = 6 and type = 2 then sku_id else null end) as cate6_type2_sku_cnt, -- cate6，type2商品数
	count(distinct case when cate = 6 and type = 3 then sku_id else null end) as cate6_type3_sku_cnt, -- cate6，type3商品数
	count(distinct case when cate = 6 and type = 4 then sku_id else null end) as cate6_type4_sku_cnt, -- cate6，type4商品数
	count(distinct case when cate = 6 and type = 5 then sku_id else null end) as cate6_type5_sku_cnt, -- cate6，type5商品数
	count(distinct case when cate = 6 and type = 6 then sku_id else null end) as cate6_type6_sku_cnt, -- cate6，type6商品数

	count(distinct case when cate = 5 and type = 1 then sku_id else null end) as cate5_type1_sku_cnt, -- cate5，type1商品数
	count(distinct case when cate = 5 and type = 2 then sku_id else null end) as cate5_type2_sku_cnt, -- cate5，type2商品数
	count(distinct case when cate = 5 and type = 3 then sku_id else null end) as cate5_type3_sku_cnt, -- cate5，type3商品数
	count(distinct case when cate = 5 and type = 4 then sku_id else null end) as cate5_type4_sku_cnt, -- cate5，type4商品数
	count(distinct case when cate = 5 and type = 5 then sku_id else null end) as cate5_type5_sku_cnt, -- cate5，type5商品数
	count(distinct case when cate = 5 and type = 6 then sku_id else null end) as cate5_type6_sku_cnt -- cate5，type6商品数
from
